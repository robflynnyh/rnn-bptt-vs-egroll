...
output_dir="${OUTPUT_DIR:-$repo_root/artifacts/dense_recall/seed-7/eggroll-from-bptt-2m-lr0p003}"
wandb_run_id="${WANDB_RUN_ID:-bpttegg4}"
...
exec "$python_bin" -u -m rnn_bptt_vs_eggroll.experiment \
    ...
    --wandb-run-name dense-recall-eggroll-from-bptt-2m-lr0p003-seed7 \
